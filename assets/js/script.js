...
/**
 * Gets the current score from DOM and increase by 1
 */
...
/**
 * Gets the current score from DOM and decrease by 1
 */
...
function displayDivisionyQuestion (operand1, operand2) {
    //document.getElementById('operand1').textContent = operand1 + (operand2 - (operand1 % operand2)) % operand2; Works sortof
